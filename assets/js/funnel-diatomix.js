...
(function () {
  ...
  stickyCTA.innerHTML =
    '<button onclick="openWhatsApp()" aria-label="Hablar con un asesor">' +
    ...
    '</svg>' +
    'Quiero más información — Hablar con un asesor' +
    '</button>';
  ...
  window.addEventListener('scroll', function () {
    ...
    if (scrolled >= SCROLL_THRESHOLD && !visible) {
      stickyCTA.classList.add('visible');
      document.body.classList.add('cta-visible');
      visible = true;
    } else if (scrolled < SCROLL_THRESHOLD && visible) {
